...
func (af *AppFactories) PlayerFactory(coords game_models.Coords, bulletType models.BulletType) game_models.IPlayer {
	return player.CreatePlayer(coords, bulletType, af.injector)
}
